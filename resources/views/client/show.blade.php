...
@section('body')
                                    ...
                                    <div class="widget-summary">
                                        <div class="widget-summary-col widget-summary-col-icon">
                                            <div class="summary-icon">
                                                <i class="fa fa-money" style="padding-top: 30%"></i>
                                            </div>
                                        </div>
                            ...
                            <section class="panel">
                                <div class="panel-body bg-secondary">
                                    <div class="widget-summary">
                                        <div class="widget-summary-col widget-summary-col-icon">
                                            <div class="summary-icon">
                                                <i class="fa fa-usd" style="padding-top: 30%"></i>
                                            </div>
                                        </div>
                                        <div class="widget-summary-col">
                                            <div class="summary">
    ...
    <div class="panel-body">
        <section class="panel-featured panel-featured-info">
            <header class="panel-heading">
                <div class="panel-actions">
                    <a href="{{ route('client.contract.create', ['client' => $client->slug]) }}" data-toggle="tooltip"
                        data-placement="top" title="Add New Contract" class="btn btn-info btn-xs">
