...
@section('body')
    ...
    <div class="row sec-body">
        <div class="col-md-4">
            <a style="text-decoration: none;" href="{{ route('client.index') }}">
        ...
        <div class="col-md-4">
            <a style="text-decoration: none;" href="{{ route('instruction.index') }}">
            ...
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">
                        ...
                        <span class="va-middle">Staff</span>
                    </h2>
                </header>
                <div class="panel-body">
                    <div class="content">
            ...
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">
                        <span
                            class="label label-primary label-sm text-weight-normal va-middle mr-sm">{{ $people->count() }}</span>
                        <span class="va-middle">Latest Activities</span>
                    </h2>
                </header>
                <div class="panel-body">
                    @foreach ($logs as $log)
