                                        ...
                                        <ul class="nav nav-children">
                                            ...
                                            <li class="nav-parent">
                                                ...
                                                <ul class="nav nav-children">
                                                    ...
                                                    <li>
                                                        <a
                                                            href="{{ route('instruction.param', ['query' => 'overdue']) }}">
                                                            Overdue
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a
                                                            href="{{ route('instruction.param', ['query' => 'kiv']) }}">
                                                            KIV
                                                        </a>
                                                    </li>
                                                    <li>
                                            ...
                                            <li class="nav-parent">
                                                ...
                                                <ul class="nav nav-children">
                                                    ...
                                                    <li>
                                                        <a
                                                            href="{{ route('task.param', ['query' => 'completed']) }}">
                                                            Completed
                                                        </a>
                                                    </li>
                                                    <li>
                                        ...
                                        <ul class="nav nav-children">
                                                ...
                                                <ul class="nav nav-children">
                                                    <li class="nav-parent">
                                                        ...
                                                        <ul class="nav nav-children">
                                                            <li>
                                                                <a
                                                                    href="{{ route('payment.param', ['param' => 'pending']) }}">
                                                                    Pending
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a
                                                                    href="{{ route('payment.param', ['param' => 'ongoing']) }}">
                                                                    Ongoing
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a
                                                                    href="{{ route('payment.param', ['param' => 'overdue']) }}">
                                                                    Overdue
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a
                                                                    href="{{ route('payment.param', ['param' => 'complete']) }}">
                                                                    Complete
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <li class="nav-parent">
                                                        ...
                                                        <ul class="nav nav-children">
                                                            <li>
                                                                <a
                                                                    href="{{ route('feenote.param', ['param' => 'pending']) }}">
                                                                    Pending
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a
                                                                    href="{{ route('feenote.param', ['param' => 'paid']) }}">
                                                                    Paid
                                                                </a>
                                                            </li>
                                                        </ul>
                                            ...
                                            <li class="nav-parent">
                                                ...
                                                <ul class="nav nav-children">
                                                    <li>
                                                        <a
                                                            href="{{ route('cashbook.param.entry', ['param' => 'debit']) }}">
                                                            Debit Entry
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a
                                                            href="{{ route('cashbook.param.entry', ['param' => 'credit']) }}">
                                                            Credit Entry
                                                        </a>
                                                    </li>
                                                    <li>
