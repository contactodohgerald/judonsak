            ...
            <header class="header">
                <div class="logo-container">
                    <a href="{{ route('landingPage') }}" class="logo">
                        <img src="{{ asset('assets/images/taxitmanagerlogo.png') }}" height="35" alt="TaxitManager" />
                    </a>
                                    ...
                                    @if ($task->slug)
                                        <li>
                                            <a href="{{ route('instruction.task.show', ['instruction' => $task->instruction->slug, 'task' => $task->slug]) }}"
                                                ...
                                                <span class="message">
                                                    {{ $notification->data['task_instruction'] }}
                                                </span>
                                            </a>
                                        </li>
                                    @endif
                                ...
                                @if (Auth::user()->unreadNotifications->count() > 0)
                                    <div class="content">
                                        <ul>
                                            @foreach (Auth::user()->unreadNotifications as $notification)
                                                <li>
                                                    <a href="/instruction/{{$notification->data['task_instruction_slug']}}/task/{{$notification->data['task_slug']}}" class="clearfix">
                                                    {{-- <a href="/instruction/{{$notification->data['task_instruction_slug']}}/task/{{$notification->data['task_slug']}}" class="clearfix"> --}}
                                                        <div class="image">
                                                            <i class="fa fa-book bg-danger"></i>
                                                        </div>
                    ...
                    <div id="userbox" class="userbox">
                        <a href="#" data-toggle="dropdown">
                            <figure class="profile-picture">
                                <img src="{{ asset('assets/images/!logged-user.jpg') }}" alt="Joseph Doe"
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <a role="menuitem" tabindex="-1"
                                        href="{{ route('profile.show', Auth::user()->person->slug) }}"><i
