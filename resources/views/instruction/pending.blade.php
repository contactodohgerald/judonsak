...
@section('body')
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <h2 class="panel-title">Pending Instructions</h2>
        </header>
        <div class="panel-body">
                ...
                <tbody>
                    @foreach ($instructions as $instruction)
                        <tr>
                            ...
                            <td>
                                <a
                                    href="
                                            {{ route('client.show', ['client' => $instruction->contract->client->slug]) }}">
					...
					@endif --}}
                            ...
                            <td>
                                ...
                                <a href="{{ route('contract.instruction.edit', ['contract' => $instruction->contract->slug, 'instruction' => $instruction->slug]) }}"
                                ...
                                <form id="delete-instruction-form-{{ $loop->iteration }}"
                                    action="{{ route('contract.instruction.destroy', ['contract' => $instruction->contract->slug, 'instruction' => $instruction->slug]) }}"
